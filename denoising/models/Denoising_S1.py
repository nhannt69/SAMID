...
from denoising.utils.base_model import BaseModel
from torch.nn import functional as F
from functools import partial
import numpy as np
from denoising.utils.beta_schedule import make_beta_schedule, default
from diffusion.ddpm import DDPM


@MODEL_REGISTRY.register()
class Denoising_S1(BaseModel):
    """Image Denoising model for test."""

    def __init__(self, opt):
        super(Denoising_S1, self).__init__(opt)
